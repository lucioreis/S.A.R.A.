  ...
  def render(assigns) do
          ...
          <div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="flex sm:items-start">
                  ...
                  <h3 class="text-lg leading-6 font-bold text-gray-900" id="modal-title">Resumo de Alterações</h3>
                  <div class="mt-2"> 
    <!-- CONTENT -->
    <div class="">
                ...
                <%= for day <- 1..6 do %>
                  <td>
                    ...
                    <%= if @horario[{ day, time }] do %>
                      <p class={"font-bold #{if @included_horario[{day, time}], do: "text-green-500", else: ""}"}>
    ...
    <!-- END OF CONTENT -->
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <button type="button" phx-click="confirm" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">Confirmar</button>
